    ...
    public static final Supplier<CreativeModeTab>  IYC_BLOCKS_TAB = CREATIVE_MODE_TAB.register("iyc_blocks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.RUBIS_BLOCK.asItem()))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModBlocks.SPEEDBOX);
                        ...
                        output.accept(ModBlocks.SPRUCE_LOG_WALL);
                        output.accept(ModBlocks.BIRCH_LOG_WALL);
                        output.accept(ModBlocks.JUNGLE_LOG_WALL);
                        output.accept(ModBlocks.ACACIA_LOG_WALL);
                        output.accept(ModBlocks.DARK_OAK_LOG_WALL);
                        output.accept(ModBlocks.MANGROVE_LOG_WALL);
                        output.accept(ModBlocks.CHERRY_LOG_WALL);
                        output.accept(ModBlocks.BAMBOO_BLOCK_WALL);
                        output.accept(ModBlocks.CRIMSON_STEM_WALL);
                        output.accept(ModBlocks.WARPED_STEM_WALL);
                        output.accept(ModBlocks.OAK_PLANKS_WALL);
                        output.accept(ModBlocks.SPRUCE_PLANKS_WALL);
                        output.accept(ModBlocks.BIRCH_PLANKS_WALL);
                        output.accept(ModBlocks.JUNGLE_PLANKS_WALL);
                        output.accept(ModBlocks.ACACIA_PLANKS_WALL);
                        output.accept(ModBlocks.DARK_OAK_PLANKS_WALL);
                        output.accept(ModBlocks.MANGROVE_PLANKS_WALL);
                        output.accept(ModBlocks.CHERRY_PLANKS_WALL);
                        output.accept(ModBlocks.BAMBOO_PLANKS_WALL);
                        output.accept(ModBlocks.CRIMSON_PLANKS_WALL);
                        output.accept(ModBlocks.WARPED_PLANKS_WALL);
                        output.accept(ModBlocks.STONE_WALL);
                        output.accept(ModBlocks.GLOWSTONE_WALL);
                        output.accept(ModBlocks.SLATE_WALL);
                        output.accept(ModBlocks.GLOWSTONE_STAIRS);
    ...
    public static final Supplier<CreativeModeTab>  IYC_DECORATIVE_TAB = CREATIVE_MODE_TAB.register("iyc_decorative_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.OAK_SHELF.get()))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModBlocks.LIGNITE_TORCH_ITEM);
                        ...
                        output.accept(ModItems.HIDDEN_DOOR_ITEM);
                    }).build());
    ...
    public static final Supplier<CreativeModeTab>  IYC_MATERIALS_TAB = CREATIVE_MODE_TAB.register("iyc_materials_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.OBSIDIAN_INGOT.get()))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModItems.RECORD_TNT);
    ...
    public static final Supplier<CreativeModeTab>  IYC_COLOR_BLOCKS_TAB = CREATIVE_MODE_TAB.register("iyc_color_blocks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.LIME_REDSTONE_LAMP.get()))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModBlocks.WHITE_IRON_FENCE);
                        output.accept(ModBlocks.ORANGE_IRON_FENCE);
                        output.accept(ModBlocks.MAGENTA_IRON_FENCE);
                        output.accept(ModBlocks.LIGHT_BLUE_IRON_FENCE);
                        output.accept(ModBlocks.YELLOW_IRON_FENCE);
                        output.accept(ModBlocks.LIME_IRON_FENCE);
                        output.accept(ModBlocks.PINK_IRON_FENCE);
                        output.accept(ModBlocks.GRAY_IRON_FENCE);
                        output.accept(ModBlocks.LIGHT_GRAY_IRON_FENCE);
                        output.accept(ModBlocks.CYAN_IRON_FENCE);
                        output.accept(ModBlocks.PURPLE_IRON_FENCE);
                        output.accept(ModBlocks.BLUE_IRON_FENCE);
                        output.accept(ModBlocks.BROWN_IRON_FENCE);
                        output.accept(ModBlocks.GREEN_IRON_FENCE);
                        output.accept(ModBlocks.RED_IRON_FENCE);
                        output.accept(ModBlocks.BLACK_IRON_FENCE);
                        ...
                        output.accept(ModBlocks.ROD);
                        output.accept(ModBlocks.ORANGE_ROD);
                        output.accept(ModBlocks.MAGENTA_ROD);
                        output.accept(ModBlocks.LIGHT_BLUE_ROD);
                        output.accept(ModBlocks.YELLOW_ROD);
                        output.accept(ModBlocks.LIME_ROD);
                        output.accept(ModBlocks.PINK_ROD);
                        output.accept(ModBlocks.GRAY_ROD);
                        output.accept(ModBlocks.LIGHT_GRAY_ROD);
                        output.accept(ModBlocks.CYAN_ROD);
                        output.accept(ModBlocks.PURPLE_ROD);
                        output.accept(ModBlocks.BLUE_ROD);
                        output.accept(ModBlocks.BROWN_ROD);
                        output.accept(ModBlocks.GREEN_ROD);
                        output.accept(ModBlocks.RED_ROD);
                        output.accept(ModBlocks.BLACK_ROD);
                        output.accept(ModBlocks.WHITE_LAMP);
                        output.accept(ModBlocks.ORANGE_LAMP);
                        output.accept(ModBlocks.MAGENTA_LAMP);
                        output.accept(ModBlocks.LIGHT_BLUE_LAMP);
                        output.accept(ModBlocks.YELLOW_LAMP);
                        output.accept(ModBlocks.LIME_LAMP);
                        output.accept(ModBlocks.PINK_LAMP);
                        output.accept(ModBlocks.GRAY_LAMP);
                        output.accept(ModBlocks.LIGHT_GRAY_LAMP);
                        output.accept(ModBlocks.CYAN_LAMP);
                        output.accept(ModBlocks.PURPLE_LAMP);
                        output.accept(ModBlocks.BLUE_LAMP);
                        output.accept(ModBlocks.BROWN_LAMP);
                        output.accept(ModBlocks.GREEN_LAMP);
                        output.accept(ModBlocks.RED_LAMP);
                        output.accept(ModBlocks.BLACK_LAMP);
                        output.accept(ModBlocks.WHITE_BLOB);
                        output.accept(ModBlocks.ORANGE_BLOB);
                        output.accept(ModBlocks.MAGENTA_BLOB);
                        output.accept(ModBlocks.LIGHT_BLUE_BLOB);
                        output.accept(ModBlocks.YELLOW_BLOB);
                        output.accept(ModBlocks.LIME_BLOB);
                        output.accept(ModBlocks.PINK_BLOB);
                        output.accept(ModBlocks.GRAY_BLOB);
                        output.accept(ModBlocks.LIGHT_GRAY_BLOB);
                        output.accept(ModBlocks.CYAN_BLOB);
                        output.accept(ModBlocks.PURPLE_BLOB);
                        output.accept(ModBlocks.BLUE_BLOB);
                        output.accept(ModBlocks.BROWN_BLOB);
                        output.accept(ModBlocks.GREEN_BLOB);
                        output.accept(ModBlocks.RED_BLOB);
                        output.accept(ModBlocks.BLACK_BLOB);
    ...
    public static final Supplier<CreativeModeTab>  IYC_FOOD_TAB = CREATIVE_MODE_TAB.register("iyc_food_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.REDBULL.get()))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModBlocks.CHERRY_CAKE_ITEM);
                    }).build());
